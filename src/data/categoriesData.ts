...
export const categoriesData: Record<string, CategoryData> = {
  ...
  'crackers': {
    ...
    description: 'Классика жанра — то, что всегда берут к пиву. Большой выбор вкусов, удобная фасовка, хорошие цены.',
    seo: { title: 'Сухарики и чипсы оптом — гренки и снеки для пивных магазинов', description: 'Ржаные и пшеничные сухарики, хлебные чипсы, гренки оптом для магазинов разливного пива. Большой выбор вкусов, свежие партии, выгодные цены.', ogImage: 'https://cdn.poehali.dev/projects/d17808fe-e6db-4a3b-97d6-d1ff859cd614/files/4522d497-a3d1-4c98-86fd-cd91438a9407.jpg' },
    benefits: ['Большой выбор вкусов', 'Разные форматы фасовки', 'Всегда свежие партии', 'Высокая оборачиваемость'],
    products: [
      { name: 'Сухарики ржаные со вкусом Бекон', description: 'Хрустящие', image: '🥖', price: '320₽/кг', unit: 'кг' },
      { name: 'Сухарики ржаные со вкусом Сыр-чеснок', description: 'Ароматные', image: '🥖', price: '320₽/кг', unit: 'кг' },
      { name: 'Сухарики ржаные со вкусом Краб', description: 'Морской вкус', image: '🥖', price: '320₽/кг', unit: 'кг' },
      { name: 'Сухарики пшеничные со вкусом Сметана-зелень', description: 'Классические', image: '🥖', price: '300₽/кг', unit: 'кг' },
      { name: 'Гренки с чесноком', description: 'Ароматные', image: '🥖', price: '280₽/кг', unit: 'кг' },
      { name: 'Чипсы хлебные Том-ям', description: 'Азиатский вкус', image: '🌾', price: '470₽/кг', unit: 'кг' },
      { name: 'Чипсы кукурузные оригинальные', description: 'Хрустящие', image: '🌽', price: '350₽/кг', unit: 'кг' },
    ]
  },
  'nuts': {
    id: 'nuts',
  ...
  'meat': {
    ...
    subtitle: 'Колбаски, чипсы, ушки',
    description: 'Мясные закуски — must-have для любого разливного бара. Охотничьи колбаски, мясные чипсы, свиные ушки. Всё что берут к тёмному пиву.',
    seo: { title: 'Мясные закуски оптом — колбаски, чипсы, ушки для пивных магазинов', description: 'Мясные закуски оптом: вяленые колбаски, мясные чипсы из курицы и свинины, свиные ушки. Всё для тёмного пива. Поставки для баров и магазинов.', ogImage: 'https://cdn.poehali.dev/projects/d17808fe-e6db-4a3b-97d6-d1ff859cd614/files/d50249bd-4e89-4da0-94d1-a8d32e654ac6.jpg' },
    benefits: ['Охотничьи колбаски — топ продаж', 'Правильная фасовка и хранение', 'Разные ценовые сегменты', 'Всегда свежие партии'],
    products: [
      { name: 'Мясные колбаски Классические', description: 'Вяленые', image: '🌭', price: '1380₽/кг', unit: 'кг' },
      { name: 'Мясные колбаски со вкусом Сыра', description: 'Вяленые', image: '🌭', price: '1450₽/кг', unit: 'кг' },
      { name: 'Мясные колбаски со вкусом Чеснока', description: 'Вяленые', image: '🌭', price: '1420₽/кг', unit: 'кг' },
      { name: 'Мясные колбаски со вкусом Чили', description: 'Острые', image: '🌭', price: '1420₽/кг', unit: 'кг' },
      { name: 'Чипсы мясные КУРИЦА', description: 'Оригинальные', image: '🍗', price: '1240₽/кг', unit: 'кг' },
      { name: 'Чипсы мясные СВИНИНА', description: 'Оригинальные', image: '🥩', price: '1310₽/кг', unit: 'кг' },
      { name: 'Чипсы мясные КУРИЦА со вкусом чеснока', description: 'С чесноком', image: '🍗', price: '1440₽/кг', unit: 'кг' },
      { name: 'Ушки свиные в/у 90 гр', description: '90г вакуум', image: '🐷', price: '60₽/шт', unit: 'шт' },
      { name: 'Ушки свиные в/у паприка 90 гр', description: 'С паприкой', image: '🐷', price: '60₽/шт', unit: 'шт' },
      { name: 'Чипсы мясные КУРИЦА 125 гр', description: '125г упаковка', image: '🍗', price: '155₽/шт', unit: 'шт' },
      { name: 'Чипсы мясные СВИНИНА 125 гр', description: '125г упаковка', image: '🥩', price: '170₽/шт', unit: 'шт' },
    ]
  }
