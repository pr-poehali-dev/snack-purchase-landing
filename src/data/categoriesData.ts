...
export const categoriesData: Record<string, CategoryData> = {
  ...
  'crackers': {
    ...
    seo: { title: 'Сухарики и чипсы оптом — гренки и снеки для пивных магазинов', description: 'Ржаные и пшеничные сухарики, хлебные чипсы, гренки оптом для магазинов разливного пива. Большой выбор вкусов, свежие партии, выгодные цены.' },
  ...
  'meat': {
    ...
    seo: { title: 'Мясные закуски оптом — колбаски, чипсы, ушки для пивных магазинов', description: 'Мясные закуски оптом: вяленые колбаски, мясные чипсы из курицы и свинины, свиные ушки. Всё для тёмного пива. Поставки для баров и магазинов.' },
