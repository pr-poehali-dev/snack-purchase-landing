...
export const categoriesData: Record<string, CategoryData> = {
  ...
  'crackers': {
    ...
    seo: { title: 'Сухарики и чипсы оптом', description: 'Сухарики, гренки и чипсы оптом для магазинов.' },
  ...
  'meat': {
    ...
    seo: { title: 'Мясные закуски оптом', description: 'Мясные снеки и колбасные изделия оптом.' },
