...
const categoriesData: Record<string, CategoryData> = {
  'fish-dried': {
    ...
    products: [
      { name: 'Вобла астраханская', description: 'С икрой, средний размер', image: '🐟', price: 'От 450₽/кг' },
      { name: 'Пелядь', description: 'Жирная, в меру соленая', image: '🐟', price: 'От 520₽/кг' },
      { name: 'Камбала с икрой', description: 'Дальневосточная', image: '🐟', price: 'От 380₽/кг' },
      { name: 'Жёлтый полосатик', description: 'Классика жанра', image: '🐟', price: 'От 290₽/кг' },
      { name: 'Икра воблы', description: 'Отдельно, развес', image: '🥚', price: 'От 680₽/кг' },
      { name: 'Чехонь вяленая', description: 'Мелкая и средняя', image: '🐟', price: 'От 420₽/кг' }
    ]
  },
  'fish-smoked': {
    id: 'fish-smoked',
    ...
    products: [
      { name: 'Сёмга холодного копчения', description: 'Нарезка, вакуум', image: '🐠', price: 'От 890₽/кг' },
      { name: 'Скумбрия копченая', description: 'Горячего копчения', image: '🐠', price: 'От 320₽/кг' },
      { name: 'Сельдь атлантическая', description: 'Слабосолёная, филе', image: '🐠', price: 'От 280₽/кг' },
      { name: 'Форель копченая', description: 'Холодного копчения', image: '🐠', price: 'От 950₽/кг' },
      { name: 'Балык из осетра', description: 'Деликатес', image: '🐠', price: 'По запросу' },
      { name: 'Корюшка сушеная', description: 'Целиком, мелкая', image: '🐠', price: 'От 420₽/кг' }
    ]
  },
  'snacks': {
    id: 'snacks',
    ...
    products: [
      { name: 'Кальмар кольца', description: 'Сушеные, солёные', image: '🦑', price: 'От 680₽/кг' },
      { name: 'Кальмар стружка', description: 'Тонкая нарезка', image: '🦑', price: 'От 720₽/кг' },
      { name: 'Кальмар щупальца', description: 'Целые, крупные', image: '🦑', price: 'От 640₽/кг' },
      { name: 'Креветки сушеные', description: 'Мелкие, целиком', image: '🦐', price: 'От 890₽/кг' },
      { name: 'Осьминог сушеный', description: 'Порционный', image: '🐙', price: 'От 980₽/кг' },
      { name: 'Гребешок сушеный', description: 'Деликатес', image: '🦪', price: 'От 1200₽/кг' }
    ]
  },
  'crackers-nuts': {
    id: 'crackers-nuts',
    ...
    products: [
      { name: 'Гренки с чесноком', description: 'Хрустящие, ароматные', image: '🥨', price: 'От 180₽/кг' },
      { name: 'Гренки со вкусом икры', description: 'Популярный вкус', image: '🥨', price: 'От 190₽/кг' },
      { name: 'Сухарики чёрные', description: 'Из бородинского хлеба', image: '🥨', price: 'От 160₽/кг' },
      { name: 'Арахис солёный', description: 'Жареный, разные вкусы', image: '🥜', price: 'От 220₽/кг' },
      { name: 'Фисташки солёные', description: 'Иранские, крупные', image: '🥜', price: 'От 480₽/кг' },
      { name: 'Сушки-баранки', description: 'Традиционные', image: '🥨', price: 'От 140₽/кг' }
    ]
  },
  'potato-chips': {
    id: 'potato-chips',
    ...
    products: [
      { name: 'Чипсы классические', description: 'Солёные, рифлёные', image: '🥔', price: 'От 160₽/кг' },
      { name: 'Чипсы со вкусом бекона', description: 'Популярный вкус', image: '🥔', price: 'От 170₽/кг' },
      { name: 'Чипсы сырные', description: 'Насыщенный вкус', image: '🥔', price: 'От 165₽/кг' },
      { name: 'Чипсы со специями', description: 'Острые вкусы', image: '🥔', price: 'От 180₽/кг' },
      { name: 'Чипсы натуральные', description: 'Без добавок', image: '🥔', price: 'От 190₽/кг' },
      { name: 'Чипсы кукурузные', description: 'Лёгкие, хрустящие', image: '🌽', price: 'От 155₽/кг' }
    ]
  },
  'seeds': {
    id: 'seeds',
    ...
    products: [
      { name: 'Семечки подсолнечные', description: 'Жареные, солёные', image: '🌻', price: 'От 95₽/кг' },
      { name: 'Семечки тыквенные', description: 'Крупные, очищенные', image: '🎃', price: 'От 280₽/кг' },
      { name: 'Семечки в кожуре', description: 'Классические', image: '🌻', price: 'От 85₽/кг' },
      { name: 'Семечки белые', description: 'Сладкие', image: '🌻', price: 'От 110₽/кг' },
      { name: 'Семечки со специями', description: 'Острые, разные вкусы', image: '🌻', price: 'От 120₽/кг' },
      { name: 'Микс семечек', description: 'Подсолнечные + тыквенные', image: '🌻', price: 'От 140₽/кг' }
    ]
  },
  'meat-dried': {
    id: 'meat-dried',
    ...
    products: [
      { name: 'Говядина вяленая', description: 'Нарезка соломкой', image: '🥩', price: 'От 890₽/кг' },
      { name: 'Свинина вяленая', description: 'Кусочки', image: '🥩', price: 'От 720₽/кг' },
      { name: 'Курица вяленая', description: 'Филе полосками', image: '🍗', price: 'От 580₽/кг' },
      { name: 'Мясные чипсы', description: 'Тонкая нарезка', image: '🥩', price: 'От 980₽/кг' },
      { name: 'Свиные ушки', description: 'Хрустящие, острые', image: '🐷', price: 'От 420₽/кг' },
      { name: 'Колбаски охотничьи', description: 'Сырокопчёные', image: '🌭', price: 'От 650₽/кг' }
    ]
  },
  'cheese': {
    id: 'cheese',
    ...
    products: [
      { name: 'Сыр копчёный колбасный', description: 'Косичка', image: '🧀', price: 'От 380₽/кг' },
      { name: 'Сыр копчёный "Косичка"', description: 'Классика', image: '🧀', price: 'От 420₽/кг' },
      { name: 'Сыр жареный', description: 'В панировке', image: '🧀', price: 'От 680₽/кг' },
      { name: 'Сыр сулугуни копчёный', description: 'Косичка', image: '🧀', price: 'От 520₽/кг' },
      { name: 'Сырные палочки', description: 'Хрустящие', image: '🧀', price: 'От 340₽/кг' },
      { name: 'Сыр чечил', description: 'Волокнистый', image: '🧀', price: 'От 480₽/кг' }
    ]
  },
  'packaging': {
    id: 'packaging',
    ...
    products: [
      { name: 'Фасовка 50-100г', description: 'Для кассовой зоны', image: '📦', price: 'От 15₽/шт' },
      { name: 'Фасовка 200-500г', description: 'Стандарт', image: '📦', price: 'От 25₽/шт' },
      { name: 'Фасовка 1кг', description: 'Оптовая', image: '📦', price: 'От 35₽/шт' },
      { name: 'Вакуумная упаковка', description: 'Для рыбы и мяса', image: '📦', price: 'От 40₽/шт' },
      { name: 'Брендированная упаковка', description: 'С вашим логотипом', image: '📦', price: 'По запросу' },
      { name: 'Картонные коробки', description: 'Для оптовых заказов', image: '📦', price: 'От 50₽/шт' }
    ]
  }
};
