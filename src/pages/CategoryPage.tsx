...
const categoriesData: Record<string, CategoryData> = {
  'fish-dried': {
    ...
    products: [
      { name: 'Вобла вяленая (крупная)', description: 'Крупная, отборная', image: '🐟', price: '450₽/кг', unit: 'кг' },
      { name: 'Вобла вяленая (отборная)', description: 'Премиум качество', image: '🐟', price: '480₽/кг', unit: 'кг' },
      { name: 'Густера', description: 'Вяленая', image: '🐟', price: '320₽/кг', unit: 'кг' },
      { name: 'Камбала вяленая (без икры)', description: 'Дальневосточная', image: '🐟', price: '350₽/кг', unit: 'кг' },
      { name: 'Камбала вяленая (икр)', description: 'С икрой', image: '🐟', price: '420₽/кг', unit: 'кг' },
      { name: 'Камбала вяленая ЕРШ', description: 'Мелкая', image: '🐟', price: '290₽/кг', unit: 'кг' },
      { name: 'Камбала чищенная тушка', description: 'Готова к употреблению', image: '🐟', price: '480₽/кг', unit: 'кг' },
      { name: 'Корюшка Вяленая Дальний Восток (без икры)', description: 'Дальневосточная', image: '🐟', price: '380₽/кг', unit: 'кг' },
      { name: 'Корюшка вяленая Дальний Восток (икр.)', description: 'С икрой', image: '🐟', price: '420₽/кг', unit: 'кг' },
      { name: 'Корюшка вяленая Ладожская', description: 'Ладожское озеро', image: '🐟', price: '450₽/кг', unit: 'кг' },
      { name: 'Красноперка вяленая', description: 'Нежная', image: '🐟', price: '340₽/кг', unit: 'кг' },
      { name: 'Лещ вял. донской', description: 'Донской', image: '🐟', price: '520₽/кг', unit: 'кг' },
      { name: 'Лещ вяленый', description: 'Классический', image: '🐟', price: '480₽/кг', unit: 'кг' },
      { name: 'Мойва вяленая', description: 'Мелкая', image: '🐟', price: '220₽/кг', unit: 'кг' },
      { name: 'Окунь вяленый', description: 'Речной', image: '🐟', price: '550₽/кг', unit: 'кг' },
      { name: 'Пелядь вяленая', description: 'Жирная', image: '🐟', price: '520₽/кг', unit: 'кг' },
      { name: 'Плотва вяленая', description: 'Классика', image: '🐟', price: '280₽/кг', unit: 'кг' },
      { name: 'Рыбец вяленый', description: 'Деликатес', image: '🐟', price: '580₽/кг', unit: 'кг' },
      { name: 'Синец вяленый', description: 'Нежный', image: '🐟', price: '320₽/кг', unit: 'кг' },
      { name: 'Судак вяленый', description: 'Крупный', image: '🐟', price: '680₽/кг', unit: 'кг' },
      { name: 'Сырок вяленый (пыжьян)', description: 'Северный', image: '🐟', price: '620₽/кг', unit: 'кг' },
      { name: 'Тюлька вяленая', description: 'Мелкая, целиком', image: '🐟', price: '180₽/кг', unit: 'кг' },
      { name: 'Уклейка вяленая', description: 'Мелкая', image: '🐟', price: '240₽/кг', unit: 'кг' },
      { name: 'Балык сырка (пыжьян)', description: 'Деликатес', image: '🐟', price: '850₽/кг', unit: 'кг' },
      { name: 'Чехонь вяленая', description: 'Мелкая и средняя', image: '🐟', price: '420₽/кг', unit: 'кг' },
      { name: 'Щука вяленая', description: 'Крупная', image: '🐟', price: '480₽/кг', unit: 'кг' },
      { name: 'Щука северная мелкая', description: 'Северная', image: '🐟', price: '380₽/кг', unit: 'кг' }
    ]
  },
  'fish-smoked': {
    id: 'fish-smoked',
